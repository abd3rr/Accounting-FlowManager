...
public class ProductService {
    ...
    public Optional<ProductCatalog> getProductByNameAndProviderId(String name, Long providerId) {
        return productRepository.findByNameAndProvider_Id(name, providerId);
    }
}